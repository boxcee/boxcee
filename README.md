...
- [boxcee/forge-flux-deployments](https://github.com/boxcee/forge-flux-deployments) - Atlassian Forge app that receives FluxCD webhook events and creates Jira deployment records (4 months ago)
